  ...
  module Types
    class Country < Value
      ...
      def self.parse(string)
        country = COUNTRIES[string.upcase]
    ...
    class Country2 < Country
      ...
      COUNTRIES = {
        'AF' => Country::COUNTRIES['AFG'],
        'AX' => Country::COUNTRIES['ALA'],
        'AL' => Country::COUNTRIES['ALB'],
        'DZ' => Country::COUNTRIES['DZA'],
        'AS' => Country::COUNTRIES['ASM'],
        'AD' => Country::COUNTRIES['AND'],
        'AO' => Country::COUNTRIES['AGO'],
        'AI' => Country::COUNTRIES['AIA'],
        'AQ' => Country::COUNTRIES['ATA'],
        'AG' => Country::COUNTRIES['ATG'],
        'AR' => Country::COUNTRIES['ARG'],
        'AM' => Country::COUNTRIES['ARM'],
        'AW' => Country::COUNTRIES['ABW'],
        'AU' => Country::COUNTRIES['AUS'],
        'AT' => Country::COUNTRIES['AUT'],
        'AZ' => Country::COUNTRIES['AZE'],
        'BS' => Country::COUNTRIES['BHS'],
        'BH' => Country::COUNTRIES['BHR'],
        'BD' => Country::COUNTRIES['BGD'],
        'BB' => Country::COUNTRIES['BRB'],
        'BY' => Country::COUNTRIES['BLR'],
        'BE' => Country::COUNTRIES['BEL'],
        'BZ' => Country::COUNTRIES['BLZ'],
        'BJ' => Country::COUNTRIES['BEN'],
        'BM' => Country::COUNTRIES['BMU'],
        'BT' => Country::COUNTRIES['BTN'],
        'BO' => Country::COUNTRIES['BOL'],
        'BQ' => Country::COUNTRIES['BES'],
        'BA' => Country::COUNTRIES['BIH'],
        'BW' => Country::COUNTRIES['BWA'],
        'BV' => Country::COUNTRIES['BVT'],
        'BR' => Country::COUNTRIES['BRA'],
        'IO' => Country::COUNTRIES['IOT'],
        'BN' => Country::COUNTRIES['BRN'],
        'BG' => Country::COUNTRIES['BGR'],
        'BF' => Country::COUNTRIES['BFA'],
        'BI' => Country::COUNTRIES['BDI'],
        'CV' => Country::COUNTRIES['CPV'],
        'KH' => Country::COUNTRIES['KHM'],
        'CM' => Country::COUNTRIES['CMR'],
        'CA' => Country::COUNTRIES['CAN'],
        'KY' => Country::COUNTRIES['CYM'],
        'CF' => Country::COUNTRIES['CAF'],
        'TD' => Country::COUNTRIES['TCD'],
        'CL' => Country::COUNTRIES['CHL'],
        'CN' => Country::COUNTRIES['CHN'],
        'CX' => Country::COUNTRIES['CXR'],
        'CC' => Country::COUNTRIES['CCK'],
        'CO' => Country::COUNTRIES['COL'],
        'KM' => Country::COUNTRIES['COM'],
        'CG' => Country::COUNTRIES['COG'],
        'CD' => Country::COUNTRIES['COD'],
        'CK' => Country::COUNTRIES['COK'],
        'CR' => Country::COUNTRIES['CRI'],
        'CI' => Country::COUNTRIES['CIV'],
        'HR' => Country::COUNTRIES['HRV'],
        'CU' => Country::COUNTRIES['CUB'],
        'CW' => Country::COUNTRIES['CUW'],
        'CY' => Country::COUNTRIES['CYP'],
        'CZ' => Country::COUNTRIES['CZE'],
        'DK' => Country::COUNTRIES['DNK'],
        'DJ' => Country::COUNTRIES['DJI'],
        'DM' => Country::COUNTRIES['DMA'],
        'DO' => Country::COUNTRIES['DOM'],
        'EC' => Country::COUNTRIES['ECU'],
        'EG' => Country::COUNTRIES['EGY'],
        'SV' => Country::COUNTRIES['SLV'],
        'GQ' => Country::COUNTRIES['GNQ'],
        'ER' => Country::COUNTRIES['ERI'],
        'EE' => Country::COUNTRIES['EST'],
        'SZ' => Country::COUNTRIES['SWZ'],
        'ET' => Country::COUNTRIES['ETH'],
        'FK' => Country::COUNTRIES['FLK'],
        'FO' => Country::COUNTRIES['FRO'],
        'FJ' => Country::COUNTRIES['FJI'],
        'FI' => Country::COUNTRIES['FIN'],
        'FR' => Country::COUNTRIES['FRA'],
        'GF' => Country::COUNTRIES['GUF'],
        'PF' => Country::COUNTRIES['PYF'],
        'TF' => Country::COUNTRIES['ATF'],
        'GA' => Country::COUNTRIES['GAB'],
        'GM' => Country::COUNTRIES['GMB'],
        'GE' => Country::COUNTRIES['GEO'],
        'DE' => Country::COUNTRIES['DEU'],
        'GH' => Country::COUNTRIES['GHA'],
        'GI' => Country::COUNTRIES['GIB'],
        'GR' => Country::COUNTRIES['GRC'],
        'GL' => Country::COUNTRIES['GRL'],
        'GD' => Country::COUNTRIES['GRD'],
        'GP' => Country::COUNTRIES['GLP'],
        'GU' => Country::COUNTRIES['GUM'],
        'GT' => Country::COUNTRIES['GTM'],
        'GG' => Country::COUNTRIES['GGY'],
        'GN' => Country::COUNTRIES['GIN'],
        'GW' => Country::COUNTRIES['GNB'],
        'GY' => Country::COUNTRIES['GUY'],
        'HT' => Country::COUNTRIES['HTI'],
        'HM' => Country::COUNTRIES['HMD'],
        'VA' => Country::COUNTRIES['VAT'],
        'HN' => Country::COUNTRIES['HND'],
        'HK' => Country::COUNTRIES['HKG'],
        'HU' => Country::COUNTRIES['HUN'],
        'IS' => Country::COUNTRIES['ISL'],
        'IN' => Country::COUNTRIES['IND'],
        'ID' => Country::COUNTRIES['IDN'],
        'IR' => Country::COUNTRIES['IRN'],
        'IQ' => Country::COUNTRIES['IRQ'],
        'IE' => Country::COUNTRIES['IRL'],
        'IM' => Country::COUNTRIES['IMN'],
        'IL' => Country::COUNTRIES['ISR'],
        'IT' => Country::COUNTRIES['ITA'],
        'JM' => Country::COUNTRIES['JAM'],
        'JP' => Country::COUNTRIES['JPN'],
        'JE' => Country::COUNTRIES['JEY'],
        'JO' => Country::COUNTRIES['JOR'],
        'KZ' => Country::COUNTRIES['KAZ'],
        'KE' => Country::COUNTRIES['KEN'],
        'KI' => Country::COUNTRIES['KIR'],
        'KP' => Country::COUNTRIES['PRK'],
        'KR' => Country::COUNTRIES['KOR'],
        'KW' => Country::COUNTRIES['KWT'],
        'KG' => Country::COUNTRIES['KGZ'],
        'LA' => Country::COUNTRIES['LAO'],
        'LV' => Country::COUNTRIES['LVA'],
        'LB' => Country::COUNTRIES['LBN'],
        'LS' => Country::COUNTRIES['LSO'],
        'LR' => Country::COUNTRIES['LBR'],
        'LY' => Country::COUNTRIES['LBY'],
        'LI' => Country::COUNTRIES['LIE'],
        'LT' => Country::COUNTRIES['LTU'],
        'LU' => Country::COUNTRIES['LUX'],
        'MO' => Country::COUNTRIES['MAC'],
        'MG' => Country::COUNTRIES['MDG'],
        'MW' => Country::COUNTRIES['MWI'],
        'MY' => Country::COUNTRIES['MYS'],
        'MV' => Country::COUNTRIES['MDV'],
        'ML' => Country::COUNTRIES['MLI'],
        'MT' => Country::COUNTRIES['MLT'],
        'MH' => Country::COUNTRIES['MHL'],
        'MQ' => Country::COUNTRIES['MTQ'],
        'MR' => Country::COUNTRIES['MRT'],
        'MU' => Country::COUNTRIES['MUS'],
        'YT' => Country::COUNTRIES['MYT'],
        'MX' => Country::COUNTRIES['MEX'],
        'FM' => Country::COUNTRIES['FSM'],
        'MD' => Country::COUNTRIES['MDA'],
        'MC' => Country::COUNTRIES['MCO'],
        'MN' => Country::COUNTRIES['MNG'],
        'ME' => Country::COUNTRIES['MNE'],
        'MS' => Country::COUNTRIES['MSR'],
        'MA' => Country::COUNTRIES['MAR'],
        'MZ' => Country::COUNTRIES['MOZ'],
        'MM' => Country::COUNTRIES['MMR'],
        'NA' => Country::COUNTRIES['NAM'],
        'NR' => Country::COUNTRIES['NRU'],
        'NP' => Country::COUNTRIES['NPL'],
        'NL' => Country::COUNTRIES['NLD'],
        'NC' => Country::COUNTRIES['NCL'],
        'NZ' => Country::COUNTRIES['NZL'],
        'NI' => Country::COUNTRIES['NIC'],
        'NE' => Country::COUNTRIES['NER'],
        'NG' => Country::COUNTRIES['NGA'],
        'NU' => Country::COUNTRIES['NIU'],
        'NF' => Country::COUNTRIES['NFK'],
        'MK' => Country::COUNTRIES['MKD'],
        'MP' => Country::COUNTRIES['MNP'],
        'NO' => Country::COUNTRIES['NOR'],
        'OM' => Country::COUNTRIES['OMN'],
        'PK' => Country::COUNTRIES['PAK'],
        'PW' => Country::COUNTRIES['PLW'],
        'PS' => Country::COUNTRIES['PSE'],
        'PA' => Country::COUNTRIES['PAN'],
        'PG' => Country::COUNTRIES['PNG'],
        'PY' => Country::COUNTRIES['PRY'],
        'PE' => Country::COUNTRIES['PER'],
        'PH' => Country::COUNTRIES['PHL'],
        'PN' => Country::COUNTRIES['PCN'],
        'PL' => Country::COUNTRIES['POL'],
        'PT' => Country::COUNTRIES['PRT'],
        'PR' => Country::COUNTRIES['PRI'],
        'QA' => Country::COUNTRIES['QAT'],
        'RE' => Country::COUNTRIES['REU'],
        'RO' => Country::COUNTRIES['ROU'],
        'RU' => Country::COUNTRIES['RUS'],
        'RW' => Country::COUNTRIES['RWA'],
        'BL' => Country::COUNTRIES['BLM'],
        'SH' => Country::COUNTRIES['SHN'],
        'KN' => Country::COUNTRIES['KNA'],
        'LC' => Country::COUNTRIES['LCA'],
        'MF' => Country::COUNTRIES['MAF'],
        'PM' => Country::COUNTRIES['SPM'],
        'VC' => Country::COUNTRIES['VCT'],
        'WS' => Country::COUNTRIES['WSM'],
        'SM' => Country::COUNTRIES['SMR'],
        'ST' => Country::COUNTRIES['STP'],
        'SA' => Country::COUNTRIES['SAU'],
        'SN' => Country::COUNTRIES['SEN'],
        'RS' => Country::COUNTRIES['SRB'],
        'SC' => Country::COUNTRIES['SYC'],
        'SL' => Country::COUNTRIES['SLE'],
        'SG' => Country::COUNTRIES['SGP'],
        'SX' => Country::COUNTRIES['SXM'],
        'SK' => Country::COUNTRIES['SVK'],
        'SI' => Country::COUNTRIES['SVN'],
        'SB' => Country::COUNTRIES['SLB'],
        'SO' => Country::COUNTRIES['SOM'],
        'ZA' => Country::COUNTRIES['ZAF'],
        'GS' => Country::COUNTRIES['SGS'],
        'SS' => Country::COUNTRIES['SSD'],
        'ES' => Country::COUNTRIES['ESP'],
        'LK' => Country::COUNTRIES['LKA'],
        'SD' => Country::COUNTRIES['SDN'],
        'SR' => Country::COUNTRIES['SUR'],
        'SJ' => Country::COUNTRIES['SJM'],
        'SE' => Country::COUNTRIES['SWE'],
        'CH' => Country::COUNTRIES['CHE'],
        'SY' => Country::COUNTRIES['SYR'],
        'TW' => Country::COUNTRIES['TWN'],
        'TJ' => Country::COUNTRIES['TJK'],
        'TZ' => Country::COUNTRIES['TZA'],
        'TH' => Country::COUNTRIES['THA'],
        'TL' => Country::COUNTRIES['TLS'],
        'TG' => Country::COUNTRIES['TGO'],
        'TK' => Country::COUNTRIES['TKL'],
        'TO' => Country::COUNTRIES['TON'],
        'TT' => Country::COUNTRIES['TTO'],
        'TN' => Country::COUNTRIES['TUN'],
        'TR' => Country::COUNTRIES['TUR'],
        'TM' => Country::COUNTRIES['TKM'],
        'TC' => Country::COUNTRIES['TCA'],
        'TV' => Country::COUNTRIES['TUV'],
        'UG' => Country::COUNTRIES['UGA'],
        'UA' => Country::COUNTRIES['UKR'],
        'AE' => Country::COUNTRIES['ARE'],
        'GB' => Country::COUNTRIES['GBR'],
        'US' => Country::COUNTRIES['USA'],
        'UM' => Country::COUNTRIES['UMI'],
        'UY' => Country::COUNTRIES['URY'],
        'UZ' => Country::COUNTRIES['UZB'],
        'VU' => Country::COUNTRIES['VUT'],
        'VE' => Country::COUNTRIES['VEN'],
        'VN' => Country::COUNTRIES['VNM'],
        'VG' => Country::COUNTRIES['VGB'],
        'VI' => Country::COUNTRIES['VIR'],
        'WF' => Country::COUNTRIES['WLF'],
        'EH' => Country::COUNTRIES['ESH'],
        'YE' => Country::COUNTRIES['YEM'],
        'ZM' => Country::COUNTRIES['ZMB'],
        'ZW' => Country::COUNTRIES['ZWE']
      }.freeze
    end
